                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex align-items-center">
                            <a href="/events/edit/{{$event->id}}" class="btn btn-primary edit-btn me-2"><i class="bi bi-pencil-square"></i> Editar</a>
    ...
    <div class="col-md-10 offset-md-1 dashboard-events-container">
        ...
        @else
        <p>Você ainda não tem inscrições, <a href="/">Criar Evento</a></p>
        @endif
    </div>
